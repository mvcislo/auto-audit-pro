...
const AdminView: React.FC = () => {
  ...
  const [appraisers, setAppraisers] = useState<Appraiser[]>(getAppraisers());
  ...
  const handleAddAppraiser = (e: React.FormEvent) => {
    ...
    saveAppraiser(app);
    setAppraisers(getAppraisers());
    setNewAppName('');
  };

  const handleRemoveAppraiser = (id: string) => {
    deleteAppraiser(id);
    setAppraisers(getAppraisers());
  };
